...
<Row><h6>Enter Your card details</h6></Row>
                  ...
                  <Row>
                    <Col>
                      <input name="name_on_card" placeholder='Name on Card'  onChange={(e) => handleChange(e)} required/>
                    </Col>
                    <Col>
                      <input name="card_number" placeholder='Card number'  onChange={(e) => handleChange(e)} required/>
                    </Col>
                  </Row>
                  <Row></Row>
                  <br></br>
                  ...
                  <Row>
                    <Col>
                      <input name="month" placeholder='Month'  onChange={(e) => handleChange(e)} required/>
                    </Col>
                    <Col>
                      <input name="year" placeholder='Year'  onChange={(e) => handleChange(e)} required />
                    </Col>
                  </Row>
                  <br></br>
                  <Row><h6>CVV</h6></Row>
                  ...
                  <Row>
                    <Col>
                      <input name="cvv" placeholder='xxx'  onChange={(e) => handleChange(e)} required/>
                    </Col>
                    <Col>
